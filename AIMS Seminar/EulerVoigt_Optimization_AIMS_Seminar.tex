...
\item<3->
Using $(\Omega = [0,2\pi]^3)$ and $V_0 = 1$, Bustamente et al. 2012 showed numerical evidence for finite-time singularity in Euler from $\be_{TGV}$ at $T^* \approx 4$. We use $(\Omega = [0,1]^3)$ and so scale down to $V_0 = 1/2\pi$.  
...
\begin{figure}
\centering
\includegraphics[width=.9\linewidth]{larios_fig_3_T3_big.png}
\caption{Log-log plot of $max_{t\in[0,T^*]}\|\nabla\ua\|_{L^2}^2$ vs $\alpha$ at $T = 0$ (blue) to $T=5.0$ (red). $C\alpha^p$ (black)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.9\linewidth]{larios_fig_3_T3.png}
\caption{Log-log plot of $max_{t\in[0,T^*]}\|\nabla\ua\|_{L^2}^2$ vs $\alpha$ at $T = 0$ (blue) to $T=5.0$ (red). $C\alpha^p$ (black)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.9\linewidth]{larios_fig_3.png}
\caption{Log-log plot of $max_{t\in[0,T^*]}\|\nabla\ua\|_{L^2}^2$ vs $\alpha$ at $T = 0$ (blue) to $T=5.0$ (red). $C\alpha^p$ (black)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.9\linewidth]{larios_fig_3_small.png}
\caption{Log-log plot of $max_{t\in[0,T^*]}\|\nabla\ua\|_{L^2}^2$ vs $\alpha$ at $T = 0$ (blue) to $T=5.0$ (red). $C\alpha^p$ (black)}
\end{figure}
...
\item<3->
Our pre-optimization results do not indicate that singularity formation will occur.
...
\item<3->
Our optimization results do not indicate that singularity formation will occur.
...
\item<2->
Repeat with higher resolutions.  

\item<3->
The optimization problem is non-convex. The TGV may not optimize to global maxima. We must expand to other initial conditions.
