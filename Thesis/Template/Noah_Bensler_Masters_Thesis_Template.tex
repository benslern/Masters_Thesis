...
\begin{appendix}
    ...
    \include{appendix_tg_seminorm_2pi}
        \setcounter{figure}{0}
        %\setcounter{equation}{0}
        \setcounter{table}{0}
        
    \include{appendix_tg_seminorm_1}
        \setcounter{figure}{0}
        %\setcounter{equation}{0}
        \setcounter{table}{0}
        
    \include{appendix_tg_seminorm_1_scaled}
        \setcounter{figure}{0}
        %\setcounter{equation}{0}
        \setcounter{table}{0}
        
    \include{appendix_tg_vorticity_2pi}
        \setcounter{figure}{0}
        %\setcounter{equation}{0}
        \setcounter{table}{0}
        
    \include{appendix_tg_vorticity_1}
        \setcounter{figure}{0}
        %\setcounter{equation}{0}
        \setcounter{table}{0}
        
    \include{appendix_tg_vorticity_1_scaled}
        \setcounter{figure}{0}
        %\setcounter{equation}{0}
        \setcounter{table}{0}
\end{appendix}
