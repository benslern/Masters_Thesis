...
module solvers
 ...
 !needed for report
  ...
  real(pr) :: K_total, E_total, H_total, maxW_global, H1_norm, H3_norm
...
!       end if
       ...
       !H3_norm  = square of h3 seminorm
       !call L2_product_fourier(temp2_solver_cx, temp2_solver_cx, H1_norm)
  ...
  SUBROUTINE kappa_test(inifield,direction,mydt,savesign,stepper,myindex)
    ...
    !call initial_condition("/scratch/noahb/Research/Uvec_fwdTE_1.nc")
