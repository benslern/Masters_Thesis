...
PROGRAM EULER_VOIGT
   ...
   if (0) then
      ...
      stepper = 3
      visc = 0.0_pr
      alpha = 4.0_pr/256.0_pr ! (2.0_pr**(arg-1))/256.0_pr
      fix_dt1 = 2.0_pr**(-5)
   ...
   if (0) then
      ...
      ! Set 3D Taylor Green Initial Condition
      !call set_initial(Uvec0, 2, 11111,2222,31234)
      call initial_condition('/scratch/noahb/Research/results/1/Uvec_fwdTE_1.nc')
      Uvec0 = Uvec
      call rescale_H1(Uvec0,PHI1)
      ...
      tau_brack(1) = 0.0_pr
      tau_brack(2) = 1.0_pr
      call report_PHI(Uvec0, tau_brack, 30, fix_dt1, 1)
   ...
   if (0) then
      ...
      stepper = 3
      visc = 0.0_pr
      alpha = 1.0_pr/1024.0_pr ! (2.0_pr**(arg-1))/256.0_pr
      fix_dt1 = 2.0_pr**(-6)
