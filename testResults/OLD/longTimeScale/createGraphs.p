...
do for [k=5:5] {
  do for [i=9:9] {
    ...
    plot for [j=0:3700:100] "alpha_".alpha."_256/resol_".(2**i)."/spectrum_fwd_".alpha.".dat" every ::(j*scale)::((j+1)*scale)-1 u 1:2 w l title "resol: ".(2**i)
