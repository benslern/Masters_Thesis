...
for i in range(300,400,10):
    ...
    uvec_fwdTE_0nc = NetCDFReader(registrationName='Wvec_fwdTE_'+my_iter+'.nc', FileName=['/home/noah/Documents/Research/Masters_Thesis/testResults/sigmaTest/sigma_-1/Wvec_fwdTE_'+my_iter+'.nc'])
    ...
    # save screenshot
    SaveScreenshot('/home/noah/Documents/Research/Masters_Thesis/testResults/sigmaTest/sigma_-1/W_iter_'+my_iter+'.png', renderView1, ImageResolution=[1366, 703])
