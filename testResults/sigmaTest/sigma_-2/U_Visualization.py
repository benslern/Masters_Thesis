...
for i in range(500,580,10):
    ...
    uvec_fwdTE_0nc = NetCDFReader(registrationName='Uvec_fwdTE_'+my_iter+'.nc', FileName=['/home/noah/Documents/Research/Masters_Thesis/testResults/sigmaTest/sigma_-2/Uvec_fwdTE_'+my_iter+'.nc'])
    ...
    # save screenshot
    SaveScreenshot('/home/noah/Documents/Research/Masters_Thesis/testResults/sigmaTest/sigma_-2/U_iter_'+my_iter+'.png', renderView1, ImageResolution=[1366, 703])
