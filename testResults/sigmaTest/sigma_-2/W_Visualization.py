...
for i in range(500,580,10):
    ResetSession()

    my_iter = str(i)
    
    # create a new 'NetCDF Reader'
    uvec_fwdTE_0nc = NetCDFReader(registrationName='Wvec_fwdTE_'+my_iter+'.nc', FileName=['/home/noah/Documents/Research/Masters_Thesis/testResults/sigmaTest/sigma_-2/Wvec_fwdTE_'+my_iter+'.nc'])
    ...
    uvec_fwdTE_0ncDisplay.OSPRayScaleArray = 'Wx'
    ...
    uvec_fwdTE_0ncDisplay.SetScaleArray = ['POINTS', 'Wx']
    uvec_fwdTE_0ncDisplay.ScaleTransferFunction = 'PiecewiseFunction'
    uvec_fwdTE_0ncDisplay.OpacityArray = ['POINTS', 'Wx']
    ...
    uvec_fwdTE_0ncDisplay.OpacityArrayName = ['POINTS', 'Wx']
    uvec_fwdTE_0ncDisplay.ColorArray2Name = ['POINTS', 'Wx']
    ...
    mergeVectorComponents1.XArray = 'Wx'
    mergeVectorComponents1.YArray = 'Wx'
    mergeVectorComponents1.ZArray = 'Wx'

    # Properties modified on mergeVectorComponents1
    mergeVectorComponents1.YArray = 'Wy'
    mergeVectorComponents1.ZArray = 'Wz'
    mergeVectorComponents1.OutputVectorName = 'W'
    ...
    mergeVectorComponents1Display.OSPRayScaleArray = 'W'
    ...
    mergeVectorComponents1Display.SetScaleArray = ['POINTS', 'W']
    mergeVectorComponents1Display.ScaleTransferFunction = 'PiecewiseFunction'
    mergeVectorComponents1Display.OpacityArray = ['POINTS', 'W']
    ...
    mergeVectorComponents1Display.OpacityArrayName = ['POINTS', 'W']
    mergeVectorComponents1Display.ColorArray2Name = ['POINTS', 'W']
    mergeVectorComponents1Display.SliceFunction = 'Plane'
    mergeVectorComponents1Display.Slice = 127
    mergeVectorComponents1Display.SelectInputVectors = ['POINTS', 'W']
    ...
    # set scalar coloring
    ColorBy(mergeVectorComponents1Display, ('POINTS', 'W', 'Magnitude'))
    ...
    uLUT = GetColorTransferFunction('W')

    # get opacity transfer function/opacity map for 'U'
    uPWF = GetOpacityTransferFunction('W')

    # get 2D transfer function for 'U'
    uTF2D = GetTransferFunction2D('W')

    # change representation type
    mergeVectorComponents1Display.SetRepresentationType('Volume')

    # Rescale transfer function
    uLUT.RescaleTransferFunction(0.0, 3.0)

    # Rescale transfer function
    uPWF.RescaleTransferFunction(0.0, 3.0)

    # Rescale 2D transfer function
    uTF2D.RescaleTransferFunction(0.0, 3.0, 0.0, 1.0)
    ...
    # Properties modified on mergeVectorComponents1Display
    mergeVectorComponents1Display.IsosurfaceValues = [0.0, 0.3, 0.6, 0.9, 1.2, 1.5, 1.8, 2.1, 2.4, 2.7, 3.0]
    ...
    # save screenshot
    SaveScreenshot('/home/noah/Documents/Research/Masters_Thesis/testResults/sigmaTest/sigma_-2/W_iter_'+my_iter+'.png', renderView1, ImageResolution=[1366, 703])
