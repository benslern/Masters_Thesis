...
p = -.55
C = 8.5
ax.plot([2,4,8,12,16,20,24,28,32,36],[C*(2)**p,C*(4)**p,C*(8)**p,C*(12)**p,C*(16)**p,C*(20)**p,C*(24)**p,C*(28)**p,C*(32)**p,C*(36)**p],'o-',color='black',ms=4)


ax.set_yticks([0.8,1,1.5,2,2.5,3,3.5,4,4.5,5])
