...
# find source
uvec_fwdTE_visual_shiftnc = GetActiveSource() #FindSource('Uvec_fwdTE_visual_shift.nc')

# create a new 'Transform'
transform1 = Transform(registrationName='Transform1', Input=uvec_fwdTE_visual_shiftnc)
transform1.Transform = 'Transform'

# Properties modified on transform1.Transform
transform1.Transform.Scale = [2.0019569472, 2.0019569472, 2.0019569472]
...
transform1Display.ScaleFactor = 102.30000000192001
transform1Display.SelectScaleArray = 'None'
transform1Display.GlyphType = 'Arrow'
transform1Display.GlyphTableIndexArray = 'None'
transform1Display.GaussianRadius = 5.115000000096
...
transform1Display.ScalarOpacityUnitDistance = 3.467491147115884
transform1Display.SelectInputVectors = [None, '']
transform1Display.WriteLog = ''

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
transform1Display.ScaleTransferFunction.Points = [-0.14606886725083984, 0.0, 0.5, 0.0, 0.14606886725083978, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
transform1Display.OpacityTransferFunction.Points = [-0.14606886725083984, 0.0, 0.5, 0.0, 0.14606886725083978, 1.0, 0.5, 0.0]

# hide data in view
Hide(uvec_fwdTE_visual_shiftnc, renderView1)
...
resampleToImage1.SamplingBounds = [0.0, 1023.0000000192, 0.0, 1023.0000000192, 0.0, 1023.0000000192]
...
resampleToImage1Display.ScaleFactor = 102.30000000192
...
resampleToImage1Display.GaussianRadius = 5.115000000096
...
resampleToImage1Display.ScalarOpacityUnitDistance = 13.951873828159185
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
resampleToImage1Display.ScaleTransferFunction.Points = [-0.14587851893454956, 0.0, 0.5, 0.0, 0.1458859539822222, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
resampleToImage1Display.OpacityTransferFunction.Points = [-0.14587851893454956, 0.0, 0.5, 0.0, 0.1458859539822222, 1.0, 0.5, 0.0]

# init the 'Plane' selected for 'SliceFunction'
resampleToImage1Display.SliceFunction.Origin = [511.50000000959994, 511.50000000959994, 511.50000000959994]
...
mergeVectorComponents1Display.ScaleFactor = 102.30000000192
...
mergeVectorComponents1Display.GaussianRadius = 5.115000000096
...
mergeVectorComponents1Display.ScalarOpacityUnitDistance = 13.951873828159185
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
mergeVectorComponents1Display.ScaleTransferFunction.Points = [-0.14587851893454956, 0.0, 0.5, 0.0, 0.1458859539822222, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
mergeVectorComponents1Display.OpacityTransferFunction.Points = [-0.14587851893454956, 0.0, 0.5, 0.0, 0.1458859539822222, 1.0, 0.5, 0.0]

# init the 'Plane' selected for 'SliceFunction'
mergeVectorComponents1Display.SliceFunction.Origin = [511.50000000959994, 511.50000000959994, 511.50000000959994]
...
extractSubset1 = ExtractSubset(registrationName='ExtractSubset1', Input=mergeVectorComponents1)
extractSubset1.VOI = [0, 127, 0, 127, 0, 127]
...
pythonCalculator1Display.ScaleFactor = 102.30000000192
...
pythonCalculator1Display.GaussianRadius = 5.115000000096
...
pythonCalculator1Display.ScalarOpacityUnitDistance = 13.951873828159185
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
pythonCalculator1Display.ScaleTransferFunction.Points = [-0.14587851893454956, 0.0, 0.5, 0.0, 0.1458859539822222, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
pythonCalculator1Display.OpacityTransferFunction.Points = [-0.14587851893454956, 0.0, 0.5, 0.0, 0.1458859539822222, 1.0, 0.5, 0.0]

# init the 'Plane' selected for 'SliceFunction'
pythonCalculator1Display.SliceFunction.Origin = [511.50000000959994, 511.50000000959994, 511.50000000959994]
