...
&= ||\bbeta||^2_{L^2} - ||\bds u(t)||^2_{L^2},
\end{aligned}
\end{equation}
%
where the second equality holds because according to Theorem \ref{thm:convergence}, the convergence of the solutions of the Euler-Voigt equations to the solution of the Euler equations is uniform on $[0, T^*]$.
Since the energy of regular solutions of the Euler equations is conserved, we have $||\bbeta||^2_{L^2} = ||\bds u(t)||^2_{L^2}$, thus
%
\begin{equation}
\limsup_{\alpha\to 0} \left(\sup_{t\in[0,T^*]}\alpha^2 ||\nabla \bds u_\alpha(t)||^2_{L^2} \right)= 0,
\end{equation}
%
